...
class PlugConfigForm(FlaskForm):
    ...
    # Plug measurements
    offset_x = FloatField('Offset X', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    offset_y = FloatField('Offset Y', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    offset_z = FloatField('Offset Z', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    vertical_gap_x = FloatField('Vertical Gap X', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    vertical_gap_y = FloatField('Vertical Gap Y', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    vertical_gap_z = FloatField('Vertical Gap Z', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    horizontal_gap_x = FloatField('Horizontal Gap X', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    horizontal_gap_y = FloatField('Horizontal Gap Y', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    horizontal_gap_z = FloatField('Horizontal Gap Z', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    slot_gap_x = FloatField('Slot Gap X', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    slot_gap_y = FloatField('Slot Gap Y', validators=[DataRequired(), NumberRange(min=-999, max=999)])
    slot_gap_z = FloatField('Slot Gap Z', validators=[DataRequired(), NumberRange(min=-999, max=999)])
